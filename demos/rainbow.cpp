...
int main()
{
    ...
    glyph_renderer_t renderer = glyph_renderer_create("font.ttf", 64.0f, NULL, GLYPH_UTF8, &rainbow_effect, 0);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glyph_renderer_draw_text(&renderer, "Rainbow Text Effect!", 50.0f, 300.0f, 1.0f, 1.0f, 1.0f, 1.0f, GLYPH_NONE);
